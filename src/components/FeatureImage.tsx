...
const FeatureImage = ({ image }: Props) => {
    return (
        <div className="w-full h-full border rounded-lg row-span-2 col-span-2 relative group transition-all delay-75  hover:bg-black">
            <input
